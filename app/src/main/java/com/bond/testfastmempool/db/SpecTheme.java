...
public class SpecTheme {
  ...
  //    public static final float[] Background3Dsurface = new float[] {
//       0f, 0f, 0f, 0f
//    };
  public static final float[] Background3Dsurface = new float[] {
      0f, 0f, 0f, 1.0f
  ...
  public static volatile boolean is_landscape = false;
  //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
//    public static Drawable fileIcon         = null; //Иконка файла
  ...
  public static void applyMetrics(AppCompatActivity dialogCtx)  {
