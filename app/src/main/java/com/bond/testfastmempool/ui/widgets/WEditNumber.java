...
import com.bond.testfastmempool.ui.i.IParamEditor;
...
//            int buttonHeight  = MeasureSpec.getSize(heightMeasureSpec);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        private class ImageArrow extends AppCompatImageView implements OnTouchListener, OnClickListener {
            ...
            final Runnable apply_hilight = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        if (hilight_lvl > 0) {
                            Presenter.runOnGUIthreadDelay(apply_hilight, 30);
                        }
                    } catch (Exception e) {}
                }
            };
